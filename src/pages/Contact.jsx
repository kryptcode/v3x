...
const Contact = () => {
  ...
  return (
    ...
    <div className={` ${darkMode ? 'bg-[#000] text-white ' : 'bg-[#d1bfa7]'} min-h-screen w-full flex flex-col md:flex-row justify-between px-4 animate__animated animate__fadeInDown`}>
      {/* <Cursor 
          isGelly={true}
          cursorSize={20}
